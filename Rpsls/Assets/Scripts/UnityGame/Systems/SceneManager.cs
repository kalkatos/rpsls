...
namespace Kalkatos.UnityGame.Systems
{
	...
	public class SceneManager : MonoBehaviour
	{
		...
		[SerializeField, Scene] private string loginScene;
		...
		public static void EndScene (string scene, object parameter = null)
		{
			...
			{
				if (parameter == null || (string)parameter == "ToLogin")
					LoadScene(Instance.loginScene);
				else
					LoadScene(Instance.menuScene);
			}
			else if (currentScene == Instance.menuScene)
			{
